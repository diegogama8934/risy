      ...
      <div className="flex-1 border rounded-2xl bg-white p-4 flex flex-col">
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col gap-1">
            <h1 className="text-xl font-bold">{singleFakeFood?.title}</h1>
            <Badge count={`$${singleFakeFood?.price || '0'}`} color="#22c55e" />
          </div>
          <Space>
        ...
        <div className="flex flex-wrap gap-3 text-sm text-gray-500 mb-4">
          ...
          <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-full">
            ...
            <span>${singleFakeFood?.price || '0'}</span>
          </div>
        </div>

        <div className="mb-4">
          <p className="text-gray-600 text-base">{singleFakeFood?.description}</p>
        </div>

        <div className="flex-1 relative rounded-lg overflow-hidden">
          <AntImage
            src={singleFakeFood?.image}
            alt={singleFakeFood?.title || 'Food image'}
            width="100%"
            height="100%"
